$(document).ready(function() {
    ...
    function closeTOC(){
        $(".web_btn-toc-div").addClass("web_toc-close");
        $(".web_btn-toc-div").removeClass("web_toc-open");
        $(".web_btn-toc-content").hide();
        $(".web_btn-toc-title").hide();
    };
    
    function openTOC(){
        $(".web_btn-toc-div").addClass("web_toc-open");
        $(".web_btn-toc-div").removeClass("web_toc-close");
        $(".web_btn-toc-content").show();
        $(".web_btn-toc-title").show();
    };
